...
// clase BOTELLA
//*************************************************************************
_botella:: _botella( int num1){

	trio.x=1; trio.y=0; trio.z=0;
	perfil.push_back(trio);
	trio.x=1; trio.y=3; trio.z=0;
	perfil.push_back(trio);
	trio.x=0.75; trio.y=3; trio.z=0;
	perfil.push_back(trio);
	trio.x=0.65; trio.y=3; trio.z=0;
	perfil.push_back(trio);
	trio.x=0.65; trio.y=4; trio.z=0;
	perfil.push_back(trio);
	num=num1;


	_rotacion::parametros(perfil,num,1);
...
// clase ESFERA
//*************************************************************************
_esfera:: _esfera(float altura,float latitud, float longitud){
	trio.x=altura; trio.y=0; trio.z=-altura;
	perfil.push_back(trio);
	num=longitud;
...
_cono:: _cono(float altura, float radio, int num1){
	trio.x=radio; trio.y=-altura/2; trio.z=0;
	perfil.push_back(trio);
	num=num1;
	//_rotacion::parametros(perfil,radio,1);
	conoCompleto(perfil, radio);

}
void _cono::conoCompleto(vector<_vertex3f>perfil, int radio){
	int i,j;
